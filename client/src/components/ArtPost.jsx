            ...
            <div className="flex flex-col justify-between self-center ">
                <div className="">
                    <div className="overflow-hidden">
                        <img className="object-cover hover:opacity-80 md:max-h-[365px] max-h-[700px] hover:scale-110 duration-500 transition-transform" src={'https://api.shyun.dev/' + image} />
                    </div>
